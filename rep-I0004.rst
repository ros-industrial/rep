...
from a special range to the standard set should be posted in the
ROS-Industrial ROS Discourse category [#rosi_rdq]_.
...
.. [#rosi_rdq] ROS-Industrial category (ROS Discourse)
   (https://discourse.ros.org/c/ros-industrial)
...
::
  ...
  2020-11-25  Add Motoman specific messages for accessing M-Registers.
